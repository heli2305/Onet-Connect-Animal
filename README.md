...
Dự án game Nối Thú được xây dựng bằng Python và Pygame, tích hợp các thuật toán tìm kiếm để tự động giải bàn cờ.
...
1. Đảm bảo đã cài đặt Python (phiên bản >= 3.8).
